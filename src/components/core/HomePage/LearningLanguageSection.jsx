   ...
   <div className='mt-[130px] mb-32'>  
      <div className='flex flex-col gap-5 items-center'>
            ...
            <div className = "flex flex-col lg:flex-row items-center justify-center mt-5">
                <img  src = {know_your_progress}  alt = "KNowYourProgressImage"  className='object-contain md:-mr-32' />
                <img  src = {compare_with_others}  alt = "CompareWithOthersImage"  className='object-contain' />
                <img  src = {plan_your_lesson}  alt = "PlanYourLessonsImage"  className='object-contain md:-ml-36' />
            </div>
      </div>
